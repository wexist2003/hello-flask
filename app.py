...
# Настраиваем логирование в корневом логгере
logging.basicConfig(
    level=logging.INFO,  # Уровень логирования (можно попробовать DEBUG)
...
def open_cards():
    ...
    logger.info(f"Ведущий: {leading_user_id}")  #  Используем logger
