...
logging.basicConfig(level=logging.DEBUG)  # Включаем подробное логирование
...
def open_cards():
    print("open_cards вызвана")  #  Проверяем вызов
